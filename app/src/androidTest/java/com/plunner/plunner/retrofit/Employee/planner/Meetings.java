...
public class Meetings extends RetrofitTest {
    ...
    public void testPut() throws Exception {
        ...
        setResponse("{\"id\":\"345\",\"title\":\"NewTitle\",\"description\":\"dsdasdas\",\"group_id\":\"45\",\"start_time\":null,\"duration\":\"900\",\"created_at\":\"2016-01-11 16:30:45\",\"updated_at\":\"2016-01-11 16:30:45\"}");
        meeting.setTitle("NewTitle");
        Execution<Meeting> execution3 = new Execution<>();
        meeting.save(execution3.getCallback());
        lock();
        assertOK();
    ...
    public void testPost() throws Exception {
        ...
        List<Meeting> meetingsList = meetings.getInstance().getModels();
        Meeting meeting = meetingsList.get(0);
        setResponse("{\"id\":\"400\",\"title\":\"NewTitle\",\"description\":\"dsdasdas\",\"group_id\":\"45\",\"start_time\":null,\"duration\":\"900\",\"created_at\":\"2016-01-11 16:30:45\",\"updated_at\":\"2016-01-11 16:30:45\"}");
        meeting.setTitle("NewTitle");
        meeting.setId(null);
        Execution<Meeting> execution3 = new Execution<>();
        meeting.save(execution3.getCallback());
    ...
    public void testDelete() throws Exception {
        ...
        setResponse("{}");
        Execution<Meeting> execution3 = new Execution<>();
        meeting.delete(execution3.getCallback());
        lock();
        assertOK();
        assertUrl("/employees/planners/groups/45/meetings/345/");
        assertMethod("DELETE");
